...
export const translations: AllTranslations = {
  en: {
    ...
    termsAgreement: "By continuing, you agree to our {termsLink} and {privacyLink}.",
  ...
  tr: {
    ...
    weatherInLocation: "{location} Hava Durumu",
    currentWeatherLoading: "Hava durumu verisi yok. Lütfen bir konum ve tarih seçin.",
    hourlyForecastForDate: "{date} İçin Tahmin",
    ...
    termsAgreement: "Devam ederek {termsLink} ve {privacyLink} kabul etmiş olursunuz.",
