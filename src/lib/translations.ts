...
export const translations: AllTranslations = {
  ...
  tr: {
    ...
    privacyS1P1: "Aşağıdaki bilgileri topluyoruz:",
    ...
    privacyS2Title: "2. Bilgilerinizi Nasıl Kullanıyoruz",
    ...
    privacyS2P2: "Verilerinizi reklam veya pazarlama amacıyla üçüncü taraflarla satmıyor veya paylaşmıyoruz.",
    privacyS3Title: "3. Üçüncü Taraf Hizmetleri",
    privacyS3P1: "Temel özellikleri sunmak için aşağıdaki üçüncü taraf hizmetlerini kullanıyoruz:",
    ...
    privacyS5P2: "Tüm geçerli veri koruma haklarına küresel olarak saygı duyuyoruz.",
    privacyS6Title: "6. Çocukların Gizliliği",
    privacyS6P1: "Weatherugo, 13 yaşın altındaki kullanıcılar için tasarlanmamıştır. Ebeveyn izni olmadan çocuklardan bilerek kişisel bilgi toplamıyoruz.",
    ...
    termsS4P1: "Hava durumu verileri WeatherAPI'den alınır ve kimlik doğrulama Google veya Apple'ı içerebilir. Üçüncü taraf içeriğinin veya hizmetlerinin doğruluğunu veya kullanılabilirliğini garanti etmiyoruz.",
