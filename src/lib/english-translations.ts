...
export const enTranslations = {
  ...
  // MainPage
  heroTitle: "Welcome to Weatherugo!", // This key exists and is used by the old hero
  heroDescription: "Your personal guide for weather-based clothing, activity suggestions, and travel planning. Get tailored advice based on your location, date, and family profile.", // This key exists and is suitable for the new design.
  downloadAppButton: "Download App", // New key for the modern hero CTA
